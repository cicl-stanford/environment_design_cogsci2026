...
<p align="center" style="font-size: smaller">
  <img width="85%" src="https://github.com/cicl-stanford/environment_design_cogsci2026/blob/main/figures/overview_fig.png"></img><br/>
</p>
...
Demos for each condition:
- [Base](https://cicl-stanford.github.io/environment_design_cogsci2026/overcooked_design/index.html?condition=0)
- [Communicative](https://cicl-stanford.github.io/environment_design_cogsci2026/overcooked_design/index.html?condition=1)
...
**Step 1:** Download the brms model cache (~4.5 GB) from OSF and unzip it into `data/overcooked_design/model_cache/`:

```bash
wget -O model_cache.zip https://osf.io/download/5vcyk/
unzip model_cache.zip -d data/overcooked_design/model_cache/
```

> **Warning:** The download is approximately 4.5 GB. If you skip this step, the Rmd will attempt to refit the models from scratch, which takes several hours.
...
For information about reproducing behavioral data preprocessing and simulation model runs, see [`project_code/python/python-readme.md`](project_code/python/python-readme.md). For details on the statistical analyses, see [`project_code/R/R-readme.md`](project_code/R/R-readme.md).
